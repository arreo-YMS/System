...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"다음",sPrevious:"이전"},sEmptyTable:"No data available in table",sInfo:"_START_ 부터 _END_ 까지  총 _TOTAL_ 개",sInfoEmpty:"_END_ 부터 _END_ 까지  총 _TOTAL_ 개",
sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ 개 보기",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"검색한 결과가 없습니다."},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
